# Simple CTF Platform Startup Script
...
Write-Host ""
Write-Host "🎉 CTF Platform is starting up!" -ForegroundColor Green
Write-Host ""
...
try {
    while ($true) {
        ...
        try {
            ...
            $frontendTest = Test-NetConnection -ComputerName localhost -Port 3000 -InformationLevel Quiet -WarningAction SilentlyContinue
